...
class FormPage():
    ...
    def upload_licence(self, driver_licence):
        self.driver.find_element(By.ID, self.licenece_copy_file_name_id).send_keys(driver_licence),time.sleep(2)
    ...
    def upload_vihicle_picture(self, vehicle_picture):
        self.driver.find_element(By.XPATH, self.upload_vihicle_picture_xpath).send_keys(vehicle_picture),time.sleep(2)
    ...
    def upload_vehicle_registration_copy(self, vehicle_registration_copy):
        self.driver.find_element(By.XPATH, self.upload_vehicle_registration_copy(vehicle_registration_copy)),time.sleep(2)

    def upload_driver_photo(self, driver_photo):
        self.driver.find_element(By.XPATH, self.upload_driver_photo(driver_photo)),time.sleep(2)
